...
class SearchResult extends React.Component {
    ...
    getData = () => {
        shopService.search(this.state.pageIndex, this.state.pageSize, this.state.latitude, this.state.longitude, 0, 0, this.props.keyword).then((response) => {
            ...
            return (
                <SafeAreaView style={ styles.container }>
                    <View style={ styles.header }>
                        <Text style={styles.title}>{this.state.total} cửa hàng được tìm thấy</Text>
                    </View>
