...
class ShopPopularScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            pageIndex: 1,
    ...
    getData = () => {
        shopService.getHome(this.state.pageIndex, this.state.pageSize, this.state.latitude, this.state.longitude).then((response) => {
...
export default ShopPopularScreen;